...
public final class ItemOrderBinding implements ViewBinding {
  ...
  private ItemOrderBinding(@NonNull CardView rootView, @NonNull TextView orderDate,
      @NonNull TextView orderId, @NonNull TextView orderItems, @NonNull TextView orderStatus,
  ...
  public static ItemOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOrderBinding((CardView) rootView, orderDate, orderId, orderItems, orderStatus,
          orderTotal);
    }
